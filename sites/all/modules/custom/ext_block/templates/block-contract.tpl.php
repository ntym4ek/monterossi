...
<div class="block-contract">
  ...
  <div class="row-1 screen-width">
    <div class="container">
      <div class="content">
        <p>Контрактное производство моторных масел и&nbsp;других смазочных материалов&nbsp;— ваш бренд, наше качество!</p>
      </div>
    </div>
  </div>
      ...
      <div class="col-xs-12 col-lg-7 col-xl-6">
        <div class="content">
          <div class="text">
            ...
            <p>Наша компания является надёжным партнёром в&nbsp;сфере контрактного производства смазочных материалов и&nbsp;технических жидкостей. Мы&nbsp;берем на&nbsp;себя все&nbsp;этапы&nbsp;— от&nbsp;разработки рецептуры до&nbsp;фасовки и&nbsp;логистики, чтобы вы&nbsp;могли сосредоточиться на&nbsp;развитии своего бренда.</p>
          </div>
          <div class="accordion">
            <div class="a-item">
    ...
    <div class="row">
      <div class="col-xs-12 col-lg-6">
        <div class="content">
          ...
          <div class="list">
            <div class="item">
              <div class="title">50 тыс. тонн в&nbsp;год</div>
            </div>
            <div class="item">
              <div class="title">8 производственных линий</div>
            </div>
            <div class="item">
              <div class="title">24 склада<br>50&nbsp;000 паллето-мест</div>
            </div>
            <div class="item">
              <div class="title">Собственные <span class="nowrap">ж/д</span>&nbsp;терминалы</div>
            </div>
          </div>
